...
%GETSIMPLIFIEDSCHEDULERIDSFORJOB Returns the smallest possible list of HTCondor JobIDs that describe the MATLAB job.
%
% SCHEDULERIDS = getSimplifiedSchedulerIDsForJob(JOB) returns the smallest
% possible list of HTCondor job IDs that describe the MATLAB job JOB. The
