...
createSubmitScript(localScriptName, jobName, remoteSubmitDescriptionFileLocation, variables);
createCommunicatingSubmitDescriptionFile(localSubmitDescriptionFileName, logFile, condorLogFile, remoteScriptName, ...
    environmentProperties.NumberOfTasks, additionalSubmitArgs, remoteJobDirectory, variables);
